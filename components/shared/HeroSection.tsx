      ...
      <div className="wrapper flex flex-col">
        <div className="grid grid-cols-1 md:grid-cols-2 min-h-[75vh]">
          <div className="flex flex-col space-y-6 justify-center flex-1">
            <Title />
            <h2 className="uppercase text-2xl font-extralight text-slate-600 dark:text-slate-400">
          ...
          <div className="flex flex-row space-x-4 pt-10">
            <Button
              size="lg"
              className="bg-indigo-600 hover:bg-indigo-800 transition-all text-white px-12"
            >
